			...
			<div class="blocks">
				<div class="block block-1">
					<div class="content">
						...
						<a href="/archive" rel=prefetch>Explore</a>
					</div>
				</div>
...
<style type="text/scss">
	...
	.chapter-3 {
		...
		.thing-1 .pod { border-bottom: 1px solid white; }
		.thing-2 .pod { background-image: url('/img/about-thing-2.png'); }
