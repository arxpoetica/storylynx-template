...
<script>
	...
	// TODO: automate these imports somehow—make them available as a variable passed from the clip???
	...
	import ClipAudio from 'storylynx/svelte/stories/media/ClipAudio.svelte'
