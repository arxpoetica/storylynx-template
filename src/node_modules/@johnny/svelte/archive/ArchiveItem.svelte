...
<div class="asset">
	<a href="/archive/{item.slug}" rel=prefetch>
		...
		<div class="texts">
			<h2>{item.title || '[This Asset has no title.]'} <span>(1974)</span></h2>
			<!-- FIXME: this needs to be an actual "content type" -->
			<h3>Press</h3>
...
<script>
	...
	$: src =
		...
		? source(item.assets[0], { crop: true })
